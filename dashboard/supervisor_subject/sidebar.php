<?php
/**
 * Subject Supervisor Sidebar
 * القائمة الجانبية لمشرف المادة
 */
...
<aside class="dashboard-sidebar">
    <div class="sidebar-header">
        <div class="logo">
            <h2>📚 SmartEdu</h2>
            <span class="role-badge">مشرف مادة</span>
        </div>
    </div>
    
    <nav class="sidebar-nav">
        <a href="../../dashboard/supervisor_subject/index.php" 
           class="nav-item <?php echo ($current_page == 'index.php') ? 'active' : ''; ?>">
            <span class="nav-icon">🏠</span>
            <span class="nav-label">الرئيسية</span>
        </a>
        
        <a href="../../dashboard/supervisor_subject/teachers.php" 
           class="nav-item <?php echo ($current_page == 'teachers.php') ? 'active' : ''; ?>">
            <span class="nav-icon">👨‍🏫</span>
            <span class="nav-label">المعلمون</span>
        </a>
        
        <a href="../../dashboard/supervisor_subject/lessons.php" 
           class="nav-item <?php echo ($current_page == 'lessons.php') ? 'active' : ''; ?>">
            <span class="nav-icon">📖</span>
            <span class="nav-label">الدروس</span>
        </a>
        
        <a href="../../dashboard/supervisor_subject/review.php" 
        ...
        <a href="../../dashboard/supervisor_subject/messages.php" 
        ...
        <a href="../../dashboard/supervisor_subject/reports.php" 
    ...
    <div class="sidebar-footer">
        <div class="user-info">
            <div class="user-avatar">
                <?php echo isset($user['name']) ? mb_substr($user['name'], 0, 1) : 'م'; ?>
            </div>
            <div class="user-details">
                <div class="user-name"><?php echo isset($user['name']) ? htmlspecialchars($user['name']) : 'مشرف مادة'; ?></div>
                <div class="user-role">
                    <?php echo isset($subject['name']) ? htmlspecialchars($subject['name']) : 'مشرف مادة'; ?>
                </div>
            </div>
        </div>
    </div>
...
<style>
    ...
    .nav-item.active::before {
        ...
        bottom: 0;
        width: 4px;
        background: linear-gradient(180deg, #22c55e, #4285F4);
    }
